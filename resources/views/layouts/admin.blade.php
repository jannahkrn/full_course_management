...
<head>
    ...
    <style>
        ...
        .nav-section-label {
            ...
            color: #9CA3AF; padding: 12px 10px 4px;
        }
...
<div class="flex flex-col h-screen overflow-hidden">
    ...
    <header class="bg-white border-b border-gray-200 flex items-center justify-between px-5 h-14 flex-shrink-0 z-40">
        ...
        <a href="{{ route('admin.courses.index') }}" class="flex items-center flex-shrink-0">
            ...
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open"
                    ...
                    <div class="text-left hidden sm:block">
                        ...
                        <div class="mt-0.5">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold border bg-yellow-50 text-yellow-700 border-yellow-200">
                                Admin
                            </span>
                        </div>
                    </div>
